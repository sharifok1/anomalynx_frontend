...
const page = () => {
    return (
        <div className='bg-gray-200'>
            <Nav />
            <section className='relative z-2 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 md:pt-20 '>
            ...
            <section className='relative md:py-20 md:mt-10'>
                {/* it services card/// */}
                <div className='relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 pt-0 py-10'>
                    <div className='flex gap-6 justify-between relative flex-col md:flex-row'>

                        <div className='p-5 py-8 bg-white rounded-xl md:w-1/4 relative pb-20 bg-opacity-70'>
